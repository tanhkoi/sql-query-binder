...
require(['vs/editor/editor.main'], function () {
    inputEditor1 = monaco.editor.create(document.getElementById('input-editor-1'), {
...
bind => [null, 0002, 0]`,
    ...
    outputEditor1 = monaco.editor.create(document.getElementById('output-editor-1'), {
        value: '',
        language: 'sql',
        theme: 'vs',
        fontSize: 14,
    ...
    inputEditor2 = monaco.editor.create(document.getElementById('input-editor-2'), {
        value: '',
        language: 'sql',
        theme: 'vs',
        fontSize: 14,
    ...
    outputEditor2 = monaco.editor.create(document.getElementById('output-editor-2'), {
        value: '',
        language: 'sql',
        theme: 'vs',
        fontSize: 14,
...
function processSQL(editorNumber) {
    ...
    if (!editors || !editors.input || !editors.output) {
        alert(`Editors ${editorNumber} are still loading. Please wait a moment and try again.`);
        return;
    }
